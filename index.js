class Book {
  ...
  renderBook(prepend) {
    ...
    imageHolder.src = "./images/"+Math.floor(Math.random() * (3-1) +1)+".png"
...
const countFavorites = () => {
  document.querySelector(".favoriteCountAdjust").textContent = arrayOfAllFavorites.reduce((acc) => acc + 1, 0);
};
...
let vinceFlynn = new Book("Flynn, Vince", "en", ["killing", "Kill", "Killed"], "American Assassin");
vinceFlynn.renderBook();
let vinceFlynn1 = new Book("Flynn, Vince", "en", ["killing", "Kill", "Killed"], "Kill Shot");
vinceFlynn1.renderBook();
let vinceFlynn2 = new Book("Flynn, Vince", "en", ["killing", "Kill", "Killed"], "Consent To Kill");
vinceFlynn2.renderBook();
let vinceFlynn3 = new Book("Flynn, Vince", "en", ["killing", "Kill", "Killed"], "The Last Man");
